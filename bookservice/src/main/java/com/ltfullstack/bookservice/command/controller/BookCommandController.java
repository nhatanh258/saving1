...
//    /là API để gửi các lệnh (command) đến các aggregate nhằm thay đổi trạng
//    thái hệ thống. Các command sẽ dẫn đến việc phát sinh sự kiện (event) nếu thành công.
    @Autowired
    ...
    public String addBook(@Valid @RequestBody BookRequestModel model){
        ...
        // gui event theo kieu dong bo (Asynchronous)
